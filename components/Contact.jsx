...
const Contact = () => {
  ...
  const formSubmit = (e) => {
    ...
    fetch("https://getform.io/f/de2065c4-f41d-4082-82b2-1f6e00cfc084", {
      method: "POST",
      body: formData
        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2'>Neel Jivani</h2>
          ...
          <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
            <div className='p-4'>
              <form
                action='https://getform.io/f/de2065c4-f41d-4082-82b2-1f6e00cfc084'
                method='POST'
